...
bl_info = {
    "name": "OBJEX Exporter",
    "author": "astronotter, Dragorn421(?), Campbell Barton, Bastien Montagne",
    "version": (1,0,0),
    "blender": (2, 80, 0),
    "location": "File > Export > OBJEX",
    "description": "Export OBJEX models",
...
class ExportOBJEX(bpy.types.Operator, ImportHelper):
    bl_idname = "export_mesh.objex"
    bl_label = "Export OBJEX"
    bl_description = """Save OBJEX mesh, material and animation data."""

    filename_ext = ".objex"
    filter_glob: StringProperty(default="*.objex", options={'HIDDEN'})
...
def menu_export(self, context):
    self.layout.operator(ExportOBJEX.bl_idname, text="OBJEX (.objex)")

def register():
    bpy.utils.register_class(ExportOBJEX)
    bpy.types.TOPBAR_MT_file_export.append(menu_export)
  
def unregister():
    bpy.utils.unregister_class(ExportOBJEX)
